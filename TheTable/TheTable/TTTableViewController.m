...
//    cell.textLabel.text = @"hello table";
    ...
    cell.detailTextLabel.text = @"I'm so fancy";
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"Warning" message:@"you should be on alert right now" delegate:self cancelButtonTitle: @"okay" otherButtonTitles:@"thats not ok", nil];
    
    [alertView show];
    
    //save in memory for next usage of app
    [[NSUserDefaults standardUserDefaults] setObject:@"yabrol" forKey:@"name"];
